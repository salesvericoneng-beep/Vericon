...
import { ArrowRight, Settings, Wrench, ShieldCheck, Award, Briefcase, Users, Building2 } from 'lucide-react';
      ...
      <div className="relative w-full h-auto lg:h-[85vh]">
        ...
        <div className="absolute inset-0 z-10 container mx-auto px-4 sm:px-8 lg:px-20 xl:px-24 pt-4 lg:pt-[80px]">
          ...
          <div className="w-[60%] sm:w-[55%] lg:w-1/2 h-full flex flex-col justify-center pb-[5%] lg:pb-0">
            ...
            >
              Delivering MEP, HVAC, Electrical and Fire Fighting Engineering Solutions with Global Standards.
            </motion.p>
          ...
          <div className="hidden lg:flex flex-col gap-4 absolute right-6 md:right-12 lg:right-20 xl:right-24 top-1/2 -translate-y-1/2 z-20">
            {/* Card 1 */}
            <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.2 }} className="bg-white/95 backdrop-blur-md rounded-xl p-5 shadow-xl border border-white/50 flex items-center gap-5 w-64 hover:-translate-x-2 transition-transform">
              <div className="text-brand-blue shrink-0"><Wrench size={40} strokeWidth={1.5} /></div>
            ...
            {/* Card 4 */}
            <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.5 }} className="bg-white/95 backdrop-blur-md rounded-xl p-5 shadow-xl border border-white/50 flex items-center gap-5 w-64 hover:-translate-x-2 transition-transform">
              <div className="text-brand-red shrink-0"><Building2 size={40} strokeWidth={1.5} /></div>
              <div className="flex flex-col">
                <span className="font-bold text-brand-red text-[17px] leading-tight">Industrial</span>
                <span className="font-bold text-gray-800 text-[17px] leading-tight mb-2">Solutions</span>
                <div className="w-8 h-[2px] bg-brand-red"></div>
              </div>
            </motion.div>
          </div>
